  ...
  return (
    <>
      <footer id={styles.footer}>
          ...
          <div className={styles.newsletter}>
            ...
            <div className={styles.subscribe}>
              <form action="" method="get" id={styles.form}>
                <input type="email" placeholder="Email Address" className="w-full outline-0 text-zinc"/>
        ...
        <div
          class="pt-8 mt-16 border-t border-gray sm:flex sm:items-center sm:justify-between lg:mt-24"
        >
          <nav aria-label="Footer Navigation - Support">
          <p class="text-xs text-gray-500">
            &copy; 2022. Afroswap X Web3Ladies. All rights reserved.
          </p>
          </nav>
